...
class byA_FB_DartBustLine(byA_PatternStep):
     ...
     def __init__(self,**kwargs):
        ...
        self._freeze("byA_FB_DartBustLine")
...
class byA_FrontDartBustLine(byA_FB_DartBustLine):
     ...
     def __init__(self,**kwargs):
        """Constructor
        """
        byA_FB_DartBustLine.__init__(self,**kwargs)
     ...
     def addToGroup(self, drawing, svggroup, **extra):
         super(byA_FrontDartBustLine, self).addToGroup("Front", drawing, svggroup, **extra)
...
class byA_BackDartBustLine(byA_FB_DartBustLine):
     ...
     def addToGroup(self, drawing, svggroup, **extra):
         super(byA_BackDartBustLine, self).addToGroup("Front", drawing, svggroup, **extra)
