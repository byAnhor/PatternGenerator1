...
class byA_BustLine(byA_PatternStep):
     ...
     def __init__(self,**kwargs):
        ...
        tableVal = self._parent._dicoMesures['Hauteurdusousbras'+self._stature]
        p1 = self._parent._dicoConstruction['WaistLine_middleBackPoint']
        p2 = self._parent._dicoConstruction['WaistLine_middleFrontPoint']
        self._middleBackPoint = byA_Point(x=p1._x, y=p1._y-20-tableVal) 
