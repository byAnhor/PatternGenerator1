...
class byA_FrontDartWaistLine(byA_FrozenClass):
     ...
     def __init__(self,**kwargs):
        ...
        ppMark = self._parent._dicoPoints['FrontDartBustLineMark_mark']
        aMark = self._parent._dicoPoints['FrontBustLineMark_mark']
        waistMark = self._parent._dicoPoints['WaistLine_middleFrontPoint']
        ...
        if (self._parent is not None):
           self._parent._dicoPoints['FrontDartWaistLineMark_dart1'] = self._dart1
           self._parent._dicoPoints['FrontDartWaistLineMark_dart2'] = self._dart2
           self._parent._dicoPoints['FrontDartWaistLineMark_dart3'] = self._dart3
