...
class byA_BackSideLine(byA_FrozenClass):
     ...
     def __init__(self,**kwargs):
        ...
        waistMark = self._parent._dicoPoints['BackDartWaistLineMark_dart1']
        hipMark = self._parent._dicoPoints['BackHipLineMark_mark']
        ...
        if (self._parent is not None):
           self._parent._dicoPoints['BackSideLine_bustToWaist'] = self._bustToWaist
           self._parent._dicoPoints['BackSideLine_waistToHip'] = self._waistToHip
           self._parent._dicoPoints['BackSideLine_8cm'] = self._8cm
           self._parent._dicoPoints['BackSideLine_1cm'] = self._1cm
